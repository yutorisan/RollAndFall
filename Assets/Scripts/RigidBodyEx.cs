...
public static class Rigidbody2DExtension
{
    ...
    {
        Velocity2DTmp velocity2DTmp = gameObject.GetComponent<Velocity2DTmp>();
        if (velocity2DTmp == null)
        {
            return;
        }

        rigidbody2D.velocity = velocity2DTmp.Velocity;
        rigidbody2D.angularVelocity = velocity2DTmp.AngularVelocity;
        rigidbody2D.bodyType = RigidbodyType2D.Dynamic;

        GameObject.Destroy(velocity2DTmp);
    }
